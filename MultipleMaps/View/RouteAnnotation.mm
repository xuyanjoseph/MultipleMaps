    ...
    switch (_type) {
        case 0:
        {
            ...
            if (view == nil) {
                ...
                view.image = [UIImage imageNamed:@"icon_location_Starting"];
        ...
        case 1:
        {
            ...
            if (view == nil) {
                ...
                view.image = [UIImage imageNamed:@"icon_location_end"];
                view.centerOffset = CGPointMake(0, -(view.frame.size.height * 0.5));
            }
        }
            break;
        ...
        case 7:
        {
            view = [mapview dequeueReusableAnnotationViewWithIdentifier:@"sharpAcce_node"];
            if (!view) {
                view = [[BMKAnnotationView alloc] initWithAnnotation:self reuseIdentifier:@"sharpAcce_node"];
                view.image = [UIImage imageNamed:@"icon_location_SharpAcceleration"];
                view.centerOffset = CGPointMake(0, -(view.frame.size.height * 0.5));
            }
        }
            break;
        case 8:
        {
            view = [mapview dequeueReusableAnnotationViewWithIdentifier:@"sharpDece_node"];
            if (!view) {
                view = [[BMKAnnotationView alloc] initWithAnnotation:self reuseIdentifier:@"sharpDece_node"];
                view.image = [UIImage imageNamed:@"icon_location_SharpDeceleration"];
                view.centerOffset = CGPointMake(0, -(view.frame.size.height * 0.5));
            }
        }
            break;
        case 9:
        {
            view = [mapview dequeueReusableAnnotationViewWithIdentifier:@"sharpTurn_node"];
            if (!view) {
                view = [[BMKAnnotationView alloc] initWithAnnotation:self reuseIdentifier:@"sharpTurn_node"];
                view.image = [UIImage imageNamed:@"icon_location_SharpCornering"];
                view.centerOffset = CGPointMake(0, -(view.frame.size.height * 0.5));
            }
        }
            break;
