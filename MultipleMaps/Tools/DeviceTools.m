...
+ (NSDictionary *)getPhoneParams {
    NSMutableDictionary *dict = [[NSMutableDictionary alloc] initWithDictionary:@{}];
    dict[@"mobile_device_type"] = @2;
    dict[@"mobile_device_id"] = [self getUUID];
    NSString *pushId = [[NSUserDefaults standardUserDefaults] objectForKey:@"geTuiCId"];
    dict[@"mobile_device_push_id"] = pushId.length > 0 ? pushId : @"";
    dict[@"mobile_device_brand"] = [self getPhoneModel];
    dict[@"mobile_device_model"] = [self iphoneType];
    dict[@"mobile_device_manufacturer"] = @"apple";
    return dict;
}
